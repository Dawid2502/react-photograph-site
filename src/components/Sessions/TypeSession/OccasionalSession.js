...
const OccasionalSession = () => {
	return (
		<div className='session-type-container'>
			<h2 className='section-title'>Sesje okolicznościowe</h2>
			<div className='session-description'>
				<div className='img-container'>
					<img
						className='session-img2'
						src={require('../../Sessions/TypeSession/boys-1331011_640.jpg')}
...
export default OccasionalSession;
