...
const WeddingSession = () => {
	return (
		<div className='session-type-container'>
			<h2 className='section-title'>Sesje ślubne</h2>
			<div className='session-description'>
				<div className='img-container'>
					<img
						className='session-img2'
						src={require('../../Sessions/TypeSession/wedding-1867547_1280.jpg')}
