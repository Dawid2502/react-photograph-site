...
const OutdoorSession = () => {
	return (
		<div className='session-type-container'>
			<h2 className='section-title'>Sesje plenerowe</h2>
			<div className='session-description'>
				<div className='img-container'>
					<img
						className='session-img2'
						src={require('../../Sessions/TypeSession/woman-7312018_1280.jpg')}
