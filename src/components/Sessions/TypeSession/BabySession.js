...
const BabySession = () => {
	return (
		<div className='session-type-container'>
			<h2 className='section-title'>Sesje noworodkowe</h2>

			<div className='session-description'>
				<div className='img-container'>
					<img
						className='session-img2'
						src={require('../../Sessions/TypeSession/baby-21249_1280.jpg')}
						alt='chłopiec z aparatem'
					/>
					<div className='background-square'></div>
				</div>
				<div className='type-text'>
					<span>Lorem</span> ipsum dolor sit amet, consectetur adipiscing elit. Nullam mi
